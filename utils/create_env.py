...
def assign_obstacles(params):
    ...
    # randomly choose obstacle matrix from the list
    matrix_list = params['sub_groups']['group_obstacle_matrix']
    matrix_index = random.randint(0,len(matrix_list)-1)
    matrix = matrix_list[matrix_index]
